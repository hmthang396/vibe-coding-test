...
Handles OTP email delivery via nodemailer with SMTP transport, defines email content standards, and ensures SMTP failures are resilient and do not affect the HTTP response layer.
